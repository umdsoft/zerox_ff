    ...
    <div style="padding: 0 0 40px 0" class="bg-white rounded tableList">
      ...
      <div>
        ...
        <div style="padding: 20px" class="flex justify-between">
          <SearchComponent @searchData="searchData" :getContracts="getContracts" :url="`/contract/return/search?type=creditor&page=${this.page + 1
            }&limit=${this.limit}`" />
          <div class="flex">
    ...
    async getContracts() {
      ...
      try {
        const response = await this.$axios.$get(
          `/contract/return?type=creditor&page=${this.page + 1}&limit=${this.limit
          }&start=${start}&end=${end}`
        );
