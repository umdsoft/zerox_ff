      ...
      <div>
        ...
        <div style="padding: 20px" class="flex justify-between">
          <SearchComponent
            ...
            :url="`/contract/return/search?type=creditor&page=${
              this.page + 1
            }&limit=${this.limit}`"
          />
          <div class="flex">
            ...
            >
              <td>
                <div>
                  ...
                  <nuxt-link
                    :to="{ name: 'user___'+ $i18n.locale, query: { id: item.debitor_uid } }"
                    >{{ item.debitor_name }}
                  </nuxt-link>
                </div>
              </td>
...
<!--  -->
          ...
          <div class="bottom-actions grid grid-cols-2 gap-6 mb-4">
            <a
              class="flex w-full"
              :href="`https://pdf.zerox.uz/index.php?id=${viewData.uid}&download=0&lang=uz`"
            >
              <button
                class="
                  rounded-lg
