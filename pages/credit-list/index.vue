    ...
    <div style="padding: 0 0 40px 0" class="bg-white rounded tableList">
      ...
      <div>
        ...
        <div style="padding: 20px" class="flex justify-between">
          <SearchComponent @searchData="searchData" :getContracts="getContracts" :url="`/contract/return?type=creditor&page=${this.page + 1
            }&limit=${this.limit}`" />
          <div class="flex">
      ...
      <div class="px-8">
        <table class="table-z">
          <thead>
            <tr>
              <th style="text-align:center;" class="py-2 px-4">{{ $t('list.debitor') }}</th>
              <th style="text-align:center;" class="py-2 px-4">{{ $t('debt_list.debtsumm') }}</th>
              <th style="text-align:center;" class="py-2 px-4">{{ $t("debt_list.debta") }}</th>
              <th style="text-align:center;" class="py-2 px-4">{{ $t('debt_list.debtol') }}</th>
              <th style="text-align:center;" class="py-2 px-4">{{ $t('debt_list.debtc') }}</th>
            </tr>
          </thead>
