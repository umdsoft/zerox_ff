          ...
          <div class="p-6">
            ...
            <div class="flex flex-col items-center text-center mb-6">
              <div class="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mb-4 shadow-lg">
                ...
                <svg v-else-if="$auth.user.gender == 2" class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 141 155">
                  ...
                  <div>
                    <div class="text-sm font-medium text-gray-900">
                      <template v-if="item.utype == 2">
                        ...
                        <span v-if="item.type == 4">{{ item.all == 1 ? (String(item.pay || '').indexOf('Sms') > -1 ? $t('a1.a108') : $t('a1.a107')) : $t('a1.a27') }}</span>
                      </template>
