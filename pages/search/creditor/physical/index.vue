<template>
  <div class="bg-white rounded-xl flex flex-col px-4 py-4">
    ...
    <div v-if="step == 1">
      <div >
       <div style="margin-top: 30px;justify-content: center; margin-bottom: 40px" class="flex items-center place-self-center">
        <input style="padding: 0 0 0 10px;" :value="id" v-mask="'######/AA'" @input="setUserId" @change="disabled" type="text"
          class="bt input  bg-white text-sm rounded" :placeholder="$t('placeholder.id')" />
      ...
      <div v-if="user != null">
          ...
          <div class="userCart__additionalInfo">
            ...
            <div class="userCart__text">
             <span v-if="sec == false && ex == false && act == false && dsds == true"> Foydalanuvchining debitor va kreditor qarzdorliklari to'g'risidagi ma'lumotlar bilan tanishib chiqqan holda qarz shartnomasi rasmiylashtirish uchun foydalanuvchidan ruxsat so'rash talab qilinadi.</span>
          ...
          <span v-if="ex == false && act == false && sec == false && dsds == false">So'rovnoma foydalanuvchi tomonidan qabul qilinmadi. Qayta so'rov yuborishingiz mumkin.</span>          
          <span v-if="act == true && ex == false &&  sec == false">So'rovnoma foydalanuvchi tomonidan qabul qilindi.</span>
            ...
            <div class="userCart__date" v-if="sec == true && act == false">
              ...
              <path
                ...
                fill="#37363C" />
              <path d="M7.6998 3.5H6.2998V7.2898L8.6049 9.5949L9.5947 8.6051L7.6998 6.7102V3.5Z" fill="#37363C" />
            </svg>
              <span id="timer" v-if="sec == true">05:00</span>
            </div>

            <div class="userCart__date" v-if="act == true && ex == false &&  sec == false">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.2002 8.35L7.3002 10.45L10.8002 6.25" stroke="#48BB78" stroke-width="2" stroke-linecap="round"
            ...
            <div class="userCart__date" v-if="ex == true && act == false && sec == false">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.1004 10.1L5.90039 5.90002M10.1004 5.90002L5.90039 10.1" stroke="#FE5E58" stroke-width="2"
            ...
            <div class="userCart__btns">
              <nuxt-link  v-if="user?.id"
              :to="{ path: '/take-money', query: { id: user?.uid } }" class="userCart__btn">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path
              ...
              <div style="background: #A0AEC0;" v-if="user?.id && dis == true && act == false" :disabled="dis" :class="dis ? 'bg-gray-300' : 'bg-t_primary'" class="userCart__btn_dis">
              <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M10.2564 4.23529H2.05128C1.50725 4.23529 0.985497 4.4584 0.600807 4.85554C0.216117 5.25268 0 5.79131 0 6.35294V10.5882C0 11.1499 0.216117 11.6885 0.600807 12.0856C0.985497 12.4828 1.50725 12.7059 2.05128 12.7059H3.07692V16.9412C3.07692 17.222 3.18498 17.4913 3.37733 17.6899C3.56967 17.8884 3.83055 18 4.10256 18H6.15385C6.42586 18 6.68674 17.8884 6.87908 17.6899C7.07143 17.4913 7.17949 17.222 7.17949 16.9412V12.7059H10.2564L15.3846 16.9412V0L10.2564 4.23529ZM13.3333 12.2824L11.2821 10.5882H2.05128V6.35294H11.2821L13.3333 4.65882V12.2824ZM20 8.47059C20 10.2812 19.0154 11.9224 17.4359 12.7059V4.23529C19.0051 5.02941 20 6.67059 20 8.47059Z"
                  fill="white" />
            ...
            <button style="background: #48BB78;" @click="sendUrl(token)" v-if="act == true"  class="userCart__btn_dis">
              <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M10.2564 4.23529H2.05128C1.50725 4.23529 0.985497 4.4584 0.600807 4.85554C0.216117 5.25268 0 5.79131 0 6.35294V10.5882C0 11.1499 0.216117 11.6885 0.600807 12.0856C0.985497 12.4828 1.50725 12.7059 2.05128 12.7059H3.07692V16.9412C3.07692 17.222 3.18498 17.4913 3.37733 17.6899C3.56967 17.8884 3.83055 18 4.10256 18H6.15385C6.42586 18 6.68674 17.8884 6.87908 17.6899C7.07143 17.4913 7.17949 17.222 7.17949 16.9412V12.7059H10.2564L15.3846 16.9412V0L10.2564 4.23529ZM13.3333 12.2824L11.2821 10.5882H2.05128V6.35294H11.2821L13.3333 4.65882V12.2824ZM20 8.47059C20 10.2812 19.0154 11.9224 17.4359 12.7059V4.23529C19.0051 5.02941 20 6.67059 20 8.47059Z"
                  fill="white" />
