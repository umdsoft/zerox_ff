            ...
            <div class="relative w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-blue-50 ring-1 ring-blue-100 shadow-sm flex items-center justify-center overflow-hidden">
              <div class="w-full h-full flex items-center justify-center p-4">
                ...
                <svg
                  ...
                  preserveAspectRatio="xMidYMid meet"
                >
                  <path d="M12 2c-2.2 0-4 1.8-4 4 0 .7.2 1.4.5 2C7 8.5 6 10 6 12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2 0-2-1-3.5-2.5-4 .3-.6.5-1.3.5-2 0-2.2-1.8-4-4-4z" fill="#E91E8C"/>
                  <path d="M12 15c-2.67 0-8 1.34-8 4v1h16v-1c0-2.66-5.33-4-8-4z" fill="#E91E8C"/>
                </svg>
