          ...
          <div class="userCart">
            ...
            <div class="userCart__additionalInfo">
              ...
              <div class="userCart__btns">
                ...
                <nuxt-link v-if="user?.id" :to="{ name: 'give-money___' + $i18n.locale, query: { id: user?.uid } }"
                  class="userCart__btn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path
...
export default {
  ...
  methods: {
    ...
    sendUrl(token) {
      this.$auth.user2 = this.user;
      this.$router.push({ name: `search-debitor-result___` + $i18n.locale, query: { secret: token } });
    },
  },
};
</script>
