            ...
            <div class="MyPractices__title flex flex-wrap gap-2 mb-3">
              <nuxt-link :to="localePath({ name: 'jonatuvchi', query: { status: '0' } })">
                <a
                  ...
                  @click="click1('0')"
                  class="bt w-full sm:w-auto ml-0 sm:ml-2 text-center font-bold py-2 rounded"
              ...
              <table class="w-full min-w-[760px] text-xs sm:text-sm table-auto">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <!-- Amount -->
                    <td
                      class="align-middle text-left sm:text-center font-semibold p-3 sm:p-4 sm:pl-6"
...
.MyPractices {
  ...
  &__table-row { border: 1px solid #ddd; background: #fff; border-radius: 10px !important; }
  &__table-output-input { border-bottom-right-radius: 10px; border-top-right-radius: 10px; }
}
...
.MyPractices__date div {
  display: flex; align-items: center; background: #f5f5f5; border-radius: 10px; width: max-content; padding: 2px 8px;
  span { margin: 0 0 0 10px; }
}

.ModalForms__IconAndPirce {
  margin: 27px 0 0 0; display: flex; align-items: center; flex-direction: column;
  span { font-weight: 600; font-size: 16px; color: #48bb78; margin: 7px 0 0 0; }
}

.ModalForms__Info {
  span { font-weight: 600; font-size: 15px; line-height: 18px; letter-spacing: 1px; }
  .ModalForms__name span { font-weight: 600; font-size: 15px; line-height: 18px; letter-spacing: 1px; color: #3d95ff; }
}
...
td {
  ...
  &:not(:first-child) { border-left: hidden; }
  &:not(:last-child)  { border-right: hidden; }
}

/* Modal overlay */
.modal {
  position: fixed; height: 500px; top: 50%; left: 50%; transform: translate(-50%, -50%);
  width: 410px; background: #fff; border-radius: 10px; z-index: 2;
  .bt2 { position: absolute; right: 0; top: 0; }
}
.over { position: fixed; top: 0; left: 0; width: 100%; height: 100vh; background: rgb(0, 0, 0, 0.5); z-index: 1; }

.uzs { font-weight: 600; font-size: 16px; line-height: 20px; letter-spacing: 1px; color: #48bb78; }

.texts {
  h1 { font-size: 12px; line-height: 15px; letter-spacing: 1px; color: #000000; }
  h2 { font-weight: 600; font-size: 15px; line-height: 18px; letter-spacing: 1px; color: #3d95ff; margin-top: 4px; }
  h3 { font-weight: 600; font-size: 15px; line-height: 18px; letter-spacing: 1px; color: #000000; }
  h5 { font-weight: 600; font-size: 15px; line-height: 18px; letter-spacing: 1px; color: #ffffff; }
  .btn1 { display: flex; align-items: center; justify-content: space-evenly; margin: 20px auto; width: 200px; height: 40px; background: #3d95ff; border-radius: 5px; }
  .sender { flex-direction: column; align-items: flex-start; display: flex; }
}
...
@media (max-width: 640px) {
  .MyPractices__title .bt { width: calc(50% - 4px) !important; }
}
