    ...
    <ZModal v-if="openModal" :width="400" @closeModal="$emit('closeModal')">
      <template #modal_body v-if="data">
        ...
        <div class="flex justify-center items-center flex-col mb-4">
          ...
          <div class="text-green-500 text-lg font-bold mt-1">{{ formatAmount(data.amount) }} UZS</div>
        </div>
        ...
        <div class="space-y-3 text-sm">
          ...
          <!-- Download Button -->
          <div class="pt-2">
            <button @click="pdfDownload" class="w-full flex items-center justify-center gap-2 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl transition-colors">
