      ...
      <div class="mt-6 lg:mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          ...
          <nuxt-link :to="localePath({ name: 'expired-type', params: { type: 'creditor' } })" class="block group">
            <div class="bg-white rounded-2xl p-5 shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 border-l-4 border-orange-500 h-full">
              <div class="flex items-start justify-between mb-4">
              ...
              <div class="border border-gray-200 rounded-xl overflow-hidden">
                ...
                <ul class="divide-y divide-gray-100">
                  ...
                  <li v-if="debitorData.length === 0" class="px-4 py-8 text-center">
                    <p class="text-gray-500 text-sm mb-3">{{ texts.noUpcomingDebts }}</p>
                    <nuxt-link :to="localePath({ name: 'index' })" class="text-blue-600 text-sm font-semibold hover:underline">
                      {{ texts.goHome }}
                    </nuxt-link>
                  </li>
                </ul>
              ...
              <div class="border border-gray-200 rounded-xl overflow-hidden">
                ...
                <ul class="divide-y divide-gray-100">
                  ...
                  <li v-if="creditorData.length === 0" class="px-4 py-8 text-center">
                    <p class="text-gray-500 text-sm mb-3">{{ texts.noUpcomingDebts }}</p>
                    <nuxt-link :to="localePath({ name: 'index' })" class="text-green-600 text-sm font-semibold hover:underline">
                      {{ texts.goHome }}
                    </nuxt-link>
                  </li>
                </ul>
