          ...
          modules: {
            ...
            items: [
              ...
              { name: "Shaxsiy qarz", desc: "Do'st va qarindoshlar bilan shaxsiy qarz oldi-berdisini yuriting.",
                features: ["Berilgan va olingan qarzlar, qisman to'lovlar", "Plastik karta rekvizitlari bilan qaytarishni talab qilish", "UZS va USD, qarzdorlar bo'yicha guruhlash", "Gap (qora kassa) - navbatli jamg'arma"] },
              { name: "Shaxsiy moliya", desc: "Shaxsiy va oilaviy budjetingizni to'liq nazorat qiling.",
                features: ["Xarajat va daromadlar kategoriyalar bo'yicha", "Budjet, maqsadlar va kutilayotgan daromadlar", "Analitika, hisobotlar va moliyaviy tavsiyalar", "Oila moliyasi va to'lovlar kalendari"] },
            ],
          },
        },
        ru: {
          ...
          modules: {
            ...
            items: [
              ...
              { name: 'Личный долг', desc: 'Ведите личные долги с друзьями и родственниками.',
                features: ['Выданные и полученные долги, частичные платежи', 'Требование возврата с реквизитами карты', 'UZS и USD, группировка по должникам', 'Гап (чёрная касса) - накопление по очереди'] },
              { name: 'Личные финансы', desc: 'Полный контроль личного и семейного бюджета.',
                features: ['Расходы и доходы по категориям', 'Бюджет, цели и ожидаемые доходы', 'Аналитика, отчёты и финансовые советы', 'Семейные финансы и календарь платежей'] },
            ],
          },
        },
        kr: {
          ...
          modules: {
            ...
            items: [
              ...
              { name: 'Шахсий қарз', desc: 'Дўст ва қариндошлар билан шахсий қарз олди-бердисини юритинг.',
                features: ['Берилган ва олинган қарзлар, қисман тўловлар', 'Пластик карта реквизитлари билан қайтаришни талаб қилиш', 'UZS ва USD, қарздорлар бўйича гуруҳлаш', 'Гап (қора касса) - навбатли жамғарма'] },
              { name: 'Шахсий молия', desc: 'Шахсий ва оилавий бюджетингизни тўлиқ назорат қилинг.',
                features: ['Харажат ва даромадлар категориялар бўйича', 'Бюджет, мақсадлар ва кутилаётган даромадлар', 'Аналитика, ҳисоботлар ва молиявий тавсиялар', 'Оила молияси ва тўловлар календари'] },
            ],
          },
        },
      };
