<template>
  <div class="pb-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm mb-6 p-1.5 flex gap-1.5 overflow-x-auto">
      ...
      <nuxt-link :to="localePath({ name: 'finance-sms' })" class="flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium text-sm whitespace-nowrap text-gray-600 hover:bg-gray-100">
