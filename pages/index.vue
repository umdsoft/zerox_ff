        ...
        >
          <div>
            ...
            <div id="chart" v-if="isChart">
              ...
              >
                <path
                  d="M93.0233 0.0093022C152.102 0.0093022 200 47.907 200 106.986C200 110.121 199.86 113.219 199.6 116.288H185.591C180.921 163.293 141.256 200.009 93.0233 200.009C41.6465 200.009 0 158.363 0 106.986C0 58.7535 36.7163 19.0884 83.7209 14.4279V0.4C86.7907 0.130232 89.8884 0.0093022 93.0233 0.0093022ZM83.7209 33.1442C64.9555 35.5319 47.8033 44.9755 35.7506 59.5555C23.6979 74.1355 17.6491 92.7578 18.8337 111.637C20.0182 130.517 28.3473 148.237 42.1279 161.196C55.9085 174.156 74.1065 181.381 93.0233 181.405C111.15 181.404 128.653 174.789 142.249 162.8C155.844 150.811 164.597 134.273 166.865 116.288H83.7209V33.1442ZM102.326 19.0977V97.6837H180.912C178.779 77.5712 169.814 58.7981 155.513 44.4966C141.211 30.1952 122.438 21.2303 102.326 19.0977Z"
                  fill="#3182CE"
                />
              </svg>
            </div>
