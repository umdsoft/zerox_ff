          ...
          <div class="w-36 h-36 rounded-full bg-gray-100 grid place-items-center overflow-hidden">
            ...
            <template v-else>
              ...
              <svg v-else-if="user.type == 2 && user.gender == 2" viewBox="0 0 24 24" class="w-28 h-28" style="color:#E91E8C">
                <path d="M12 1C10 1 8.5 2.5 8 5c-.5 2.5-2 5.5-3.5 8-.4.7 0 1.5.7 1.5h13.6c.7 0 1.1-.8.7-1.5C18 10.5 16.5 7.5 16 5c-.5-2.5-2-4-4-4z" fill="currentColor" />
                <path d="M12 16c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" fill="currentColor" />
              </svg>
