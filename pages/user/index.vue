        ...
        <section class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col items-center">
          ...
          <div class="w-36 h-36 rounded-full bg-gray-100 grid place-items-center overflow-hidden">
            ...
            <template v-else>
              ...
              <svg v-if="user.type == 2 && user.gender == 1" viewBox="0 0 150 150" class="w-28 h-28 text-blue-500">
                <g clip-path="url(#c0)">
                  <path
              ...
              <svg v-else-if="user.type == 2 && user.gender == 2" viewBox="0 0 150 150" class="w-28 h-28 text-blue-500">
                <path
