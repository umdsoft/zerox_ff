    ...
    texts() {
      ...
      const t = {
        ...
        en: {
          ...
          subtitle: 'Log in to keep the shop debt ledger',
          phone: 'Phone number',
          password: 'Password',
          passwordPlaceholder: 'Enter your password',
          loginBtn: 'Log in',
          loading: 'Logging in...',
          ownerLogin: 'Log in as the shop owner',
          hint: 'On your first login you choose your own password — use the same password next time.',
          errInvalid: 'Incorrect phone number or password',
          errDisabled: 'Login is blocked. Contact the shop owner.',
          errFields: 'Enter your phone number and password',
        },
        kaa: {
          title: 'Xızmetker kiriwi',
          subtitle: 'Dúkan qarız dápterin júrgiziw ushın kiriń',
          phone: 'Telefon nomeri',
          password: 'Parol',
          passwordPlaceholder: 'Parolıńızdı kiritiń',
          loginBtn: 'Kiriw',
          loading: 'Kirilmekte...',
          ownerLogin: 'Dúkan iyesi sıpatında kiriw',
          hint: 'Birinshi kiriwde parolıńızdı ózińiz saylaysız — keyingi ret usı parol menen kire beriń.',
          errInvalid: 'Telefon yamasa parol nadurıs',
          errDisabled: 'Login bloklanǵan. Dúkan iyesine múrájat etiń.',
          errFields: 'Telefon hám paroldı kiritiń',
        },
      };
      return t[l] || t.uz;
    },
