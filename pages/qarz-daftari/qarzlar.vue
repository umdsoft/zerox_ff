  ...
  computed: {
    ...
    texts() {
      ...
      const t = {
        ...
        en: {
          titleBerilgan: 'Debts given',
          titleOlingan: 'Debts received',
          titleExpiredDebitor: 'Overdue debts given',
          titleExpiredKreditor: 'Overdue debts received',
          subtitleBerilgan: 'List of people who owe you',
          subtitleOlingan: 'List of people you owe',
          subtitleExpired: 'Debts past their repayment date',
          titleNearDebitor: 'Debts given due soon',
          titleNearKreditor: 'Debts received due soon',
          subtitleNear: 'Debts nearing their repayment date',
          back: 'Back',
          searchPlaceholder: 'Search by full name or phone number',
          exportExcel: 'Export to Excel',
          phoneCol: 'Phone',
          exportError: 'Export error',
          itemsLabel: 'debts',
          mijozlarLabel: 'customers',
          qoldiqQarz: 'Remaining debt',
          undirilganQarz: 'Collected debt',
          qaytarilganQarz: 'Repaid debt',
          total: 'Total debts',
          activeCount: 'Debts in progress',
          totalUzs: 'Total remaining',
          totalUsd: 'Total remaining',
          dokonlar: 'Shops',
          selectDokon: 'Select a business (shop)',
          allDokon: 'All shops',
          dokonQarzlar: 'Number of debts',
          dokonJamiQarz: 'Debt amount',
          taLabel: '',
          newDokon: 'Add a new shop',
          noDokon: 'No shops found',
          client: 'Customer',
          savdoFaoliyat: 'Business (shop) name',
          registrar: 'Phone number of the person who entered it',
          amount: 'Debt amount',
          remaining: 'Remaining',
          totalRemaining: 'Total remaining',
          debtsCount: 'Number of debts',
          lastDateBerish: 'Last date given',
          lastDateCol: 'Last date',
          lastDateOlish: 'Last date received',
          dateGiven: 'Date given',
          dateReturn: 'Repayment date',
          status: 'Status',
          installment: 'Instalments',
          month: 'months',
          empty: 'No debts',
          emptyDesc: 'There are no debts in this section yet',
          statusActive: 'Active',
          statusClosed: 'Closed',
          statusForgiven: 'Waived',
          statusExpired: 'Overdue',
        },
        kaa: {
          titleBerilgan: 'Berilgen qarızlar',
          titleOlingan: 'Alınǵan qarızlar',
          titleExpiredDebitor: 'Múddeti ótken berilgen qarızlar',
          titleExpiredKreditor: 'Múddeti ótken alınǵan qarızlar',
          subtitleBerilgan: 'Sizden qarız alǵan shaxslar dizimi',
          subtitleOlingan: 'Siz qarız alǵan shaxslar dizimi',
          subtitleExpired: 'Qaytarıw múddeti ótken qarızlar',
          titleNearDebitor: 'Múddeti jaqın berilgen qarızlar',
          titleNearKreditor: 'Múddeti jaqın alınǵan qarızlar',
          subtitleNear: 'Qaytarıw múddeti jaqınlasqan qarızlar',
          back: 'Artqa',
          searchPlaceholder: 'F.A.Á. yamasa telefon nomeri boyınsha izlew',
          exportExcel: 'Excelge júklew',
          phoneCol: 'Telefon',
          exportError: 'Eksport etiwde qátelik',
          itemsLabel: 'qarız',
          mijozlarLabel: 'klient',
          qoldiqQarz: 'Qalǵan qarız',
          undirilganQarz: 'Óndirilgen qarız',
          qaytarilganQarz: 'Qaytarılǵan qarız',
          total: 'Jámi qarızlar',
          activeCount: 'Barısındaǵı qarızlar',
          totalUzs: 'Jámi qaldıq',
          totalUsd: 'Jámi qaldıq',
          dokonlar: 'Dúkanlar',
          selectDokon: 'Sawda iskerligin (dúkandı) saylań',
          allDokon: 'Barlıq dúkanlar',
          dokonQarzlar: 'Qarızlar sanı',
          dokonJamiQarz: 'Qarız muǵdarı',
          taLabel: '',
          newDokon: 'Jańa dúkan qosıw',
          noDokon: 'Dúkan tabılmadı',
          client: 'Klient',
          savdoFaoliyat: 'Sawda iskerligi (dúkan) atı',
          registrar: 'Kiritken shaxstıń telefon nomeri',
          amount: 'Qarız muǵdarı',
          remaining: 'Qaldıq',
          totalRemaining: 'Jámi qaldıq',
          debtsCount: 'Qarızlar sanı',
          lastDateBerish: 'Sońǵı berilgen sáne',
          lastDateCol: 'Sońǵı sáne',
          lastDateOlish: 'Sońǵı alınǵan sáne',
          dateGiven: 'Berilgen sáne',
          dateReturn: 'Qaytarıw sánesi',
          status: 'Halatı',
          installment: 'Bólip tólew',
          month: 'ay',
          empty: 'Qarızlar joq',
          emptyDesc: 'Bul bólimde házirshe qarızlar joq',
          statusActive: 'Aktiv',
          statusClosed: 'Jabılǵan',
          statusForgiven: 'Waz keshilgen',
          statusExpired: 'Múddeti ótken',
        },
      };
      return t[l] || t.uz;
    },
