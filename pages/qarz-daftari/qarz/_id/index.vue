  ...
  computed: {
    texts() {
      ...
      const t = {
        ...
        en: { title: "Debt details", history: "Transaction history", receipt: "Receipt", totalDebt: "Total debt", remaining: "Remaining", date: "Date given", dateOlish: "Date received", returnDate: "Repayment date", installment: "Instalments", month: "months", installmentTable: "Instalment schedule", actions: "Actions", demand: "Demand repayment", sending: "Sending...", closeDebt: "Close the debt", forgive: "Waive the debt", repay: "Repay the debt", active: "Active", closed: "Closed", forgiven: "Waived", loading: "Loading...", errorTitle: "Could not load data", errorDesc: "The debt data is unavailable or the server could not be reached. Please try again.", retry: "Try again", back: "Back", qarzOluvchi: "Borrower", qarzBeruvchi: "Lender", mahsulot: "Product / service", recommendation: "Recommendation", relOntime: "on time", rel_none: "No data yet", rel_none_desc: "There is no previous debt history with this customer.", rel_reliable: "Reliable", rel_reliable_desc: "Mostly repaid previous debts on time.", rel_medium: "Average", rel_medium_desc: "Sometimes repaid debts late.", rel_risky: "Be careful", rel_risky_desc: "Often repaid debts late." },
        kaa: { title: "Qarız detalları", history: "Ámeliyatlar tariyxı", receipt: "Kvitanciya", totalDebt: "Jámi qarız", remaining: "Qaldıq", date: "Berilgen sáne", dateOlish: "Alınǵan sáne", returnDate: "Qaytarıw sánesi", installment: "Bólip tólew", month: "ay", installmentTable: "Bólip tólew kestesi", actions: "Ámeller", demand: "Qaytarıwdı talap etiw", sending: "Jiberilmekte...", closeDebt: "Qarızdı jabıw", forgive: "Qarızdan waz keshiw", repay: "Qarızdı qaytarıw", active: "Aktiv", closed: "Jabılǵan", forgiven: "Waz keshilgen", loading: "Júklenbekte...", errorTitle: "Maǵlıwmattı júklep bolmadı", errorDesc: "Qarız maǵlıwmatı joq yamasa server menen baylanıs ornatılmadı. Qaytadan urınıp kóriń.", retry: "Qaytadan urınıw", back: "Artqa", qarzOluvchi: "Qarız alıwshı", qarzBeruvchi: "Qarız beriwshi", mahsulot: "Ónim / xızmet", recommendation: "Usınıs", relOntime: "óz waqtında", rel_none: "Házirshe maǵlıwmat joq", rel_none_desc: "Bul klient penen aldınǵı qarız tariyxı joq.", rel_reliable: "Isenimli", rel_reliable_desc: "Aldınǵı qarızların tiykarınan óz waqtında qaytarǵan.", rel_medium: "Ortasha", rel_medium_desc: "Qarızların geyde keshiktirip qaytarǵan.", rel_risky: "Abaylı bolıń", rel_risky_desc: "Qarızların kóbinese keshiktirip qaytarǵan." },
      };
      return t[l] || t.uz;
    },
