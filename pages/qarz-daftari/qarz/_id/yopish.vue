  ...
  computed: {
    ...
    texts() {
      ...
      const t = {
        ...
        en: {
          title: "Close the debt",
          back: "Back",
          qoldiq: "Remaining",
          jamiQarz: "Total debt",
          valyutaLabel: "Select currency",
          amountExceeds: "The payment amount exceeds the remaining debt.",
          ...
          fullyClosed: "The debt will be fully closed",
        ...
        kaa: {
          ...
          qoldiq: "Qaldıq",
          jamiQarz: "Jámi qarız",
          valyutaLabel: "Valyutanı saylań",
          amountExceeds: "Tólem summası qalǵan qarızdan asıp ketti.",
          formTitle: "Tólem maǵlıwmatları",
          summa: "Tólem summası",
          ...
          fullyClosed: "Qarız tolıq jabıladı",
