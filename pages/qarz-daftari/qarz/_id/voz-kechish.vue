  ...
  computed: {
    ...
    texts() {
      ...
      const t = {
        ...
        en: {
          title: "Waive the debt",
          confirmTitle: "Confirm the waiver",
          back: "Back",
          warning: "By waiving the debt you lose the right to demand it. Please think carefully before confirming the waiver.",
          qoldiq: "Remaining",
          formTitle: "Waiver details",
          summa: "Amount to waive",
          summaPlaceholder: "Enter the amount",
          maxHint: "Maximum:",
          izoh: "Note (optional)",
          izohPlaceholder: "Reason for the waiver",
          quickAmounts: "Quick amount",
          allRemaining: "All",
          cancel: "Cancel",
          confirm: "Confirm the waiver",
          saving: "Saving...",
          summary: "Calculation",
          currentRemaining: "Current remaining",
          forgiveAmount: "To be waived",
          afterRemaining: "New remaining",
          fullyForgiven: "The debt will be fully waived",
          errorTitle: "Debt not found",
        },
        kaa: {
          title: "Qarızdan waz keshiw",
          confirmTitle: "Waz keshiwdi tastıyıqlaw",
          back: "Artqa",
          warning: "Qarızdan waz keshiw nátiyjesinde siz qarızdı talap etiw huqıqınan ayrılasız. Sonlıqtan waz keshiwdi tastıyıqlawdan aldın jaqsılap oylap kóriń.",
          qoldiq: "Qaldıq",
          formTitle: "Waz keshiw maǵlıwmatları",
          summa: "Waz keshiletuǵın summa",
          summaPlaceholder: "Summanı kiritiń",
          maxHint: "Maksimal:",
          izoh: "Túsinik (ıqtıyarıy)",
          izohPlaceholder: "Waz keshiw sebebi",
          quickAmounts: "Tez summa",
          allRemaining: "Hámmesi",
          cancel: "Biykar etiw",
          confirm: "Waz keshiwdi tastıyıqlaw",
          saving: "Saqlanbaqta...",
          summary: "Esap-kitap",
          currentRemaining: "Házirgi qaldıq",
          forgiveAmount: "Waz keshiledi",
          afterRemaining: "Jańa qaldıq",
          fullyForgiven: "Qarızdan tolıq waz keshiledi",
          errorTitle: "Qarız tabılmadı",
        },
      };
      return t[l] || t.uz;
    },
