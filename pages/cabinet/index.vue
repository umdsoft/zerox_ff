  ...
  <div class="bg-white rounded-xl">
    ...
    <div class="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4">
      ...
      <div class="flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          @click="$router.go(-1)"
          class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 hover:underline px-0 py-1 rounded transition"
        >
          <svg width="10" height="16" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.8625 2.225L8.37916 0.75L0.137497 9L8.3875 17.25L9.8625 15.775L3.0875 9L9.8625 2.225Z" fill="currentColor"/>
          </svg>
          <span>{{ $t('back') }}</span>
        </button>
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18.001" viewBox="0 0 18 18.001" class="shrink-0">
            <path d="M5.808,13.782v1.406A2.816,2.816,0,0,0,8.621,18h7.067A2.816,2.816,0,0,0,18.5,15.188V2.813A2.816,2.816,0,0,0,15.687,0H8.621A2.816,2.816,0,0,0,5.808,2.813V4.219a.7.7,0,0,0,1.406,0V2.813A1.408,1.408,0,0,1,8.621,1.406h7.067a1.408,1.408,0,0,1,1.406,1.406V15.188a1.408,1.408,0,0,1-1.406,1.406H8.621a1.408,1.408,0,0,1-1.406-1.406V13.782a.7.7,0,0,0-1.406,0ZM1.014,7.793,2.589,6.218a.7.7,0,0,1,.994.994l-1.12,1.12h8.443a.7.7,0,1,1,0,1.406H2.463l1.12,1.12a.7.7,0,1,1-.994.994L1.014,10.279A1.76,1.76,0,0,1,1.014,7.793Zm0,0" fill="white"/>
          </svg>
          <span>{{ $t('a1.a05') }}</span>
        </button>
      </div>
          ...
          <div class="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-4 sm:p-5">
            <div class="flex flex-col items-center text-center">
              ...
              <div
                ...
                <svg v-if="user.type == 1 && user.image == null" width="106" height="122" viewBox="0 0 106 122" fill="none" xmlns="http://www.w3.org/2000/svg" class="scale-75 sm:scale-90">
                ...
                <svg v-if="user.type == 2 && user.gender == 1 && user.image == null" width="106" height="122" viewBox="0 0 106 122" fill="none" xmlns="http://www.w3.org/2000/svg" class="scale-75 sm:scale-90">
                ...
                <svg v-if="user.gender === null && user.image == null" width="106" height="122" viewBox="0 0 106 122" fill="none" xmlns="http://www.w3.org/2000/svg" class="scale-75 sm:scale-90">
                  <path d="M53 61C69.7281 61 83.2857 47.3465 83.2857 30.5C83.2857 13.6535 69.7281 0 53 0C36.2719 0 22.7143 13.6535 22.7143 30.5C22.7143 47.3465 36.2719 61 53 61ZM42.1871 72.4375C18.8813 72.4375 0 91.4523 0 114.923C0 118.831 3.14688 122 7.02723 122H98.9728C102.853 122 106 118.831 106 114.923C106 91.4523 87.1188 72.4375 63.813 72.4375H42.1871V72.4375Z" fill="#3182CE"/>
                </svg>
                <svg v-if="user.type == 2 && user.gender == 2 && user.image == null" width="106" height="122" viewBox="0 0 106 122" xmlns="http://www.w3.org/2000/svg" class="scale-75 sm:scale-90">
            ...
            <div class="mt-3 sm:mt-4 space-y-2">
              ...
              <button
                v-if="$auth.user.is_active == 1 && $auth.user.is_contract != 0"
          ...
          <div v-if="user.type == 2" class="rounded-2xl bg-white shadow-sm ring-1 ring-blue-200 p-4 sm:p-5">
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div class="p-3 rounded-lg bg-blue-50 ring-1 ring-blue-100 sm:col-span-2">
                ...
                <dd class="mt-1 text-sm text-gray-900 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 break-words">
                  <span class="break-words">{{ user?.phone }}</span>
                  <nuxt-link :to="localePath({ name: 'rephone' })" class="inline-flex items-center text-blue-500 hover:text-blue-600">
                    <span class="pan w-4 h-4 mr-2">
                      <svg class="fill-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V285.7l-86.8 86.8c-10.3 10.3-17.5 23.1-21 37.2l-18.7 74.9c-2.3 9.2-1.8 18.8 1.3 27.5H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128zM549.8 235.7l14.4 14.4c15.6 15.6 15.6 40.9 0 56.6l-29.4 29.4-71-71 29.4-29.4c15.6-15.6 40.9-15.6 56.6 0zM311.9 417L441.1 287.8l71 71L382.9 487.9c-4.1 4.1-9.2 7-14.9 8.4l-60.1 15c-5.5 1.4-11.2-.2-15.2-4.2s-5.6-9.7-4.2-15.2l15-60.1c1.4-5.6 4.3-10.8 8.4-14.9z"/></svg>
                    </span>
                  </nuxt-link>
                </dd>
              </div>
