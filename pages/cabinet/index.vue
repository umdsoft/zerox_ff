      ...
      <div class="flex rounded-xl px-4 py-6" style="width: 100%" v-if="user != null">
        <div class="bg-white rounded py-4" style="width: 500px">
          <div class="flex flex-col items-center border-b pb-4 border-blue-300">
            ...
            <svg v-if="user.type == 2 && user.gender == 1 && user.image == null" width="150" height="150" viewBox="0 0 106 122" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <svg v-if="user.type == 2 && user.gender == 2 && user.image == null" width="150" height="150" viewBox="0 0 106 122"
