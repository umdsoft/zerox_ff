        ...
        <tbody>
          ...
          >
            ...
            <td class="border underline border-gray-300 px-4 py-1">
              <p v-if="region.gender == 1">Erkaklar</p>
              <p v-if="region.gender == 2">Ayollar</p>
            </td>
...
export default {
  ...
  async mounted(){
    ...
    this.regions = response.byGender
    response.byGender.forEach(element => {
      if(element.gender == 1){
        this.chartOptions.labels.push('Erkaklar')
        this.series.push(element.cnt)
      }
      if(element.gender == 2){
        this.chartOptions.labels.push('Ayollar')
        this.series.push(element.cnt)
      }
    });
  },
