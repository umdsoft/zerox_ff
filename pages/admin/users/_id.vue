        ...
        <div class="bg-white  rounded py-4" style="width:500px"> 
          <div class="flex flex-col  items-center " >
            ...
            <img
              ...
              alt="avatar"
            />
            <span class="text-center font-bold mt-4 px-2">{{user.last_name}} {{user.first_name}} {{user.middle_name}}</span>
...
<!-- {{ user }} -->
        <tbody v-if="user.type == 2">
          ...
          >
            ...
            <td class="border border-gray-300 px-4 py-2">{{user.middle_name}}</td>
          </tr>
            <tr
            class="border border-gray-300"
          >
            <td class="border border-gray-300 px-4 py-2">Tug'ilgan sanasi</td>
            <td class="border border-gray-300 px-4 py-2">{{user.brithday}} yil</td>
          </tr>
            <tr
            class="border border-gray-300"
          >
          ...
          >
            ...
            <td class="border border-gray-300 px-4 py-2"><span v-if="user.contract_date != null">{{dateFormat(user.contract_date)}} <span v-if="user.con_time != null">{{ user.con_time.slice(0,5)}}</span></span></td>
          </tr>

             <tr
            class="border border-gray-300"
          >
            <td class="border border-gray-300 px-4 py-2">Pasport ma'lumoti</td>
            <td class="border border-gray-300 px-4 py-2"><b>Pasport seriasi:</b> {{user.passport}} <p><b>Kim tomonidan berilgan:</b> {{user.issued_by}}</p> 
            <p>
              <b>Berilgan vaqti:</b> {{dateFormat(user.issued_date)}} yil
