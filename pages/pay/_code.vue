    ...
    texts() {
      ...
      const t = {
        ...
        en: {
          ...
          overdue: "overdue",
          payWith: "pay via",
          secureNote: "The payment is processed securely",
        },
        kaa: {
          paymentPage: "Qarız tólew beti",
          notFound: 'Silteme tabılmadı',
          notFoundDesc: "Bul silteme jaramsız yamasa múddeti ótken",
          creditor: 'Qarız beriwshi',
          debtor: 'Qarızdar',
          totalAmount: 'Qarız summası',
          paidAmount: "Tólengen",
          remainingAmount: 'Qalǵan summa',
          dueDate: 'Múddet',
          overdue: "múddeti ótken",
          payWith: "arqalı tólew",
          secureNote: "Tólem qáwipsiz túrde ámelge asırıladı",
        },
      };
      return t[l] || t.uz;
    },
