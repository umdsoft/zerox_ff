    ...
    <div class="pagebreak">
      <div class="box qarz">
        <div class="content-title">
          <h2 class="font-bold">D А L О L А Т N О М А</h2>

          <p>
            ( <span>{{ contract.number }}</span> - sonli qarz shartnomasi
            bo‘yicha muddatni uzaytirish buyicha to‘g‘risida )
          </p>
        </div>
        <div class="content-body">
          ...
          <p>
            ...
            <b>{{ dateFormat(act.end_date) }}</b> yilgacha uzaytirildi.
          </p>
          <p>
            <b>{{ contract.number }}</b
            >-sonli qarz shartnomasining yangi muddati sifatida
            <b>{{ dateFormat(act.end_date) }}</b> yil belgilandi.
          </p>
          <p>
            Mazkur dalolatnoma Imzo orqali tasdiqlangan holda elektron tarzda
            tuzildi.
          </p>
          <p>
