    ...
    <div class="pagebreak">
      <div class="box qarz">
        <div class="content-title">
          ...
          <p>
            ( <span>{{ contract.number }}</span> -sonli qarz shartnomasining
            muddatini uzaytirish to'g'risida )
          </p>
        </div>
        <div class="content-body">
          <p>
            Biz quyida Imzo qiluvchilar,
            <span
          ...
          <p>
            ...
            >
            o'rtasida tuzilgan <span>{{ contract.number }}</span> - sonli qarz
            shartnomasining muddati
            <span> {{ dateFormat(act.end_date) }}</span> yilgacha uzaytirildi.
          </p>
          <p>
            <span>{{ contract.number }}</span> - sonli qarz shartnomasing yangi
            muddati sifatida <span> {{ dateFormat(act.end_date) }}</span> yil
            belgilandi.
          </p>
          <p>
            Mazkur dalolatnoma maxsus elektron imzo orqali tasdiqlangan xolda
          ...
          <p>
            Maxsus elektron imzo orqali tasdiqlangan Dalolatnomaning
        ...
        <div class="content-body">
          <div class="flex">
            ...
            <div class="rekvizit">
              ...
              <div class="rek-body">
                <h2>
                  {{ $t('comp.time') }}: <span>{{ dateFormat(act.updatedAt) }}</span> yil
                </h2>
              </div>
            </div>
          </div>
