<template>
  <div class="userCart">
    <div class="userCart__info cursor-pointer" @click="content = !content">
      <div class="userCart__start">
        <div class="userCart__Icon">
          ...
          >
            <path
              d="M24.1143 16.0736L18.0838 13.517L15.5337 12.4358C15.5977 12.3999 15.6585 12.3592 15.7213 12.3212H19.0696C19.3186 12.3212 19.5574 12.2333 19.7335 12.0768C19.9096 11.9203 20.0085 11.7081 20.0085 11.4868V9.29128H20C19.8976 6.2316 18.7019 3.53984 16.9062 1.85189C15.9593 0.902843 14.732 0.258053 13.3591 0.0653689C13.2979 0.0564705 13.2367 0.0482566 13.1751 0.0410694C13.1042 0.0331978 13.0337 0.0253262 12.9621 0.0201925C12.8082 0.00743965 12.6538 0.000702326 12.4992 0H12.4985C12.3452 0 12.1939 0.0078717 12.0429 0.019508C11.9705 0.024984 11.8989 0.0328554 11.8272 0.040727C11.7672 0.0475719 11.7075 0.0551013 11.6482 0.0639997C10.2865 0.253261 9.0677 0.888127 8.12346 1.82348C6.31046 3.50973 5.10166 6.21415 4.99846 9.29162H4.99037V11.4871C4.99037 11.7084 5.08929 11.9206 5.26535 12.0771C5.44142 12.2336 5.68022 12.3215 5.92922 12.3215H9.28681C9.37847 12.377 9.46973 12.4334 9.56446 12.4841L7.12223 13.4947L0.896103 16.0718C0.355052 16.297 0 16.8392 0 17.4446V23.5246C0 24.3395 0.638863 25 1.42791 25H23.5721C24.3611 25 25 24.3395 25 23.5246V17.4439C24.9996 16.8405 24.65 16.3035 24.1143 16.0736Z"
              fill="white"
            />
          </svg>
          ...
          >
            <path
              d="M12.5 12.5C16.4453 12.5 19.6429 9.70215 19.6429 6.25C19.6429 2.79785 16.4453 0 12.5 0C8.55469 0 5.35714 2.79785 5.35714 6.25C5.35714 9.70215 8.55469 12.5 12.5 12.5ZM17.846 14.0918L15.1786 23.4375L13.3929 16.7969L15.1786 14.0625H9.82143L11.6071 16.7969L9.82143 23.4375L7.15402 14.0918C3.17522 14.2578 0 17.1045 0 20.625V22.6562C0 23.9502 1.19978 25 2.67857 25H22.3214C23.8002 25 25 23.9502 25 22.6562V20.625C25 17.1045 21.8248 14.2578 17.846 14.0918V14.0918Z"
              fill="white"
            />
          </svg>
        </div>
      ...
      <div class="userCart__end">
        ...
        <div class="userCart__arrow" :class="{ active: content }">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="8"
    ...
    <div class="userCart__additionalInfo" v-show="content">
      <hr />
