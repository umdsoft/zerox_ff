...
export default {
  ...
  computed: {
    ...
    t() {
      const m = {
        uz: {
          // SS-DEV (2026-09-24), mobil hujjat 3-rasm: qarz daftarida "Qaytarilgan" → "Undirilgan"
          given: 'Berilgan', returned: 'Undirilgan',
          monthGiven: 'Oyda berilgan', monthReturned: 'Oyda undirilgan',
          ...
          pickDay: "Sanani tanlang — o'sha kuni berilgan va undirilgan qarzlar shu yerda ko'rinadi.",
          dayAnalysis: "Kun tahlili — berilgan va undirilgan qarzlar", close: 'Yopish',
          givenList: 'Berilgan qarzlar', returnedList: 'Undirilgan qarzlar',
          noGiven: "Bu kunda berilgan qarz yo'q", noReturned: "Bu kunda undirilgan qarz yo'q",
        },
        ru: {
          given: 'Выдано', returned: 'Взыскано',
          monthGiven: 'Выдано за месяц', monthReturned: 'Взыскано за месяц',
          ...
          pickDay: 'Выберите дату — здесь появятся выданные и взысканные долги за этот день.',
          dayAnalysis: 'Анализ дня — выданные и взысканные долги', close: 'Закрыть',
          givenList: 'Выданные долги', returnedList: 'Взысканные долги',
          noGiven: 'В этот день долги не выдавались', noReturned: 'В этот день долги не взыскивались',
        },
        kr: {
          given: 'Берилган', returned: 'Ундирилган',
          monthGiven: 'Ойда берилган', monthReturned: 'Ойда ундирилган',
          ...
          pickDay: 'Санани танланг — ўша куни берилган ва ундирилган қарзлар шу ерда кўринади.',
          dayAnalysis: 'Кун таҳлили — берилган ва ундирилган қарзлар', close: 'Ёпиш',
