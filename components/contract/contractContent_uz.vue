<template>
  <div>
    <div class="header flex mt-16 pagebreak">
      <div class="logo">
        <svg
          width="180"
          height="120"
    ...
    <div class="box qarz">
      ...
      <div class="content-body">
        <p>
          ...
          >
          yilda <span>{{ contract.debitor.issued_by }}</span> tomonidan
          ...
          >
          yilda
          <span>{{ contract.creditor.issued_by }}</span>
          tomonidan berilgan) (keyingi o'rinlarda “Qarz oluvchi”) ikkinchi
          tomondan xamda “Infinity payment system” MCHJ (STIR: 309053853)
          (keyingi o'rinlarda “Jamiyat”) uchinchi tomondan ushbu shartnomani
          quyidagilar xaqida tuzdilar
        </p>
      </div>
    </div>
    <div class="box qarz">
        ...
        <ul>
          <li>
            <p>
              ...
              {{ contract.currency }} miqdorida pul mablag'i foyizsiz qarzga
              beradi, Qarz oluvchi esa o'z zimmasiga mazkur mablag'ni qaytarish
              majburyatini oladi;
            </p>
          </li>
          <li>
            <p>
              1.2.Mazkur shartnomaning 1.1-bandida qayd etilgan miqdordagi qarz
              summasi Qarz oluvchi tomonidan Qarz beruvchiga qismlarga bo'lip
              qaytarilishi mumkun;
            </p>
          </li>
          <li>
    ...
    <div class="box qarz">
      ...
      <div class="content-body">
        <ul>
          <li>
            <p>
              2.1.Qarz beruvchi mazkur shartnoma imzolangan kundan boshlap 1 kun
              muddat ichida shartnomaning 1.1-bandida ko'rsatilgan miqdordagi
              pul mablag'ini naqd yoki naqdsiz shaklda Qarz oluvchiga
              dalolatnoma asosida taqdim etiladi; Dalolatnomada u tuzilgan sana,
              taraflarning rekvizitlari, Qarz oluvchiga pul mablag'i taqdim
              etilgan sana va boshqa malumotlar ko'rsatiladi. Ushbu dalolatnoma
              Tomonlar tomindan maxsus elktron imzo (keyingi o'rinlarda “Imzo”)
              bilan imzolangandan so'ng mazkur qarz shartnomasing ajralmas qismi
              xisoplanadi.
            </p>
          </li>
          <li>
            <p>
              2.2.Qarz oluvhi olingan qarz summasini mazkur shartnomaning
              1.3-bandida nazarda tutilgan muddatga qadar Qarz beruvhciga
              qaytaradi;
            </p>
          </li>
          <li>
            <p>
              2.3.Qarz beruvchi Qarz oluvchidan shartnoma bo'yicha berilgan qarz
              summasini shartnomada kelishilgan muddatdan avval talab qilishga,
              qarz shartnomasi mudadtini uzaytirishga va qarzdan voz kechishga
              xaqli.
            </p>
          </li>
          <li class="pagebreak">
            <p>
              2.4.Qarz oluvchi Qarz beruvchi qarzni qaytarish haqida talab
              qo'ygan kundan boshlab 1 oy (oʼttiz kun) mobaynida qarzni
              qaytarishi lozim. Аgar Qarz oluvchi oʼttiz kunlik muddatda Qarz
              beruvchiga qarzni qaytarmasa, qarz muddati buzilgan hisoblanadi va
              har bir kechiktirilgan kun uchun 3.1-bandida belgilangan tartibda
              penya toʼlaydi
            </p>
          </li>
          <li>
            <p>
              2.5.Qarz oluvchi qarz summasini muddatidan avval Qarz beruvchiga
              qaytarishga va qarz shartnomasi muddatini uzaytirish uchun
              soʼrovnoma yuborishga haqli.
            </p>
          </li>
          <li>
            <p>
              2.6.Tomonlar mazkur shartnomani elektron shaklda
              tasdiqlashganliklari bilan ular qarz shartnomasidagi maʼlumotlar
              (foydalanuvchining statusi, debitor va kreditor qarzdorliklarining
              jami summasi hamda muddati oʼtgan qarzdorliklarining summasi) ning
              uchinchi shaxslarga berilishiga rozilik bildirishganligini
              anglatadi. Bunda Jamiyat tomonidan tomonlarning shaxsiga oid
              maʼlumotlar uchinchi shaxslarga taqdim qilinmaydi.
            </p>
          </li>
        </ul>
      </div>
    ...
    <div class="box qarz">
      ...
      <div class="content-body">
        <ul>
          <li>
            <p>
              3.1.Qarz oluvchi ushbu shartnomaning 1.3-bandida nazarda tutilgan
              muddatga qadar Qarz beruvchiga qarzni qaytarmasa, har bir
              kechiktirilgan kun uchun 0,5 (yarim) foiz, lekin qarz summasining
              50 (ellik) foizidan ortiq boʼlmagan miqdorda penya toʼlaydi.
            </p>
          </li>
        </ul>
      </div>
    ...
    <div class="box qarz">
      ...
      <div class="content-body">
        <ul>
          <li>
            <p>
              4.1.Mazkur shartnoma Qarz beruvchi va Qarz oluvchi tomonidan
              “ZeroX” dasturi orqali elektron tarzda tuziladi va Imzo bilan
              tasdiqlanadi.
            </p>
          </li>
          <li>
            <p>
              4.2.“ZeroX” dasturidan foydalanish boʼyicha tuzilgan “Universal
              shartnoma”ning 11-bandiga asosan birinchi va ikkinchi tomonlar
              shartnomani oʼzlariga individual tarzda berilgan maxsus elektron
              imzo bilan imzolanishiga roziligini bildiradi hamda maxsus
              elektron imzo qoʼlda qoʼyilgan imzo bilan bir hil ahamiyatga ega
              ekanligini zimmasiga oladi.
            </p>
          </li>
          <li>
            <p>
              4.3.Shartnoma tomonlar imzolangan vaqtdan boshlab kuchga kiradi va
              <span>{{ dateFormat(contract.end_date) }}</span> yilga qadar amal
              qiladi.
            </p>
          </li>
          <li>
            <p>
              4.4.Qarz oluvchi qarz summasini muddatidan avval Qarz beruvchiga
              qaytargan taqdirda qarz summasi qarz beruvchi tomonidan qabul
              qilib olinganligi haqida dalolatnoma Imzo bilan imzolangan kundan
              shartnoma bekor boʼlishi mumkin.
            </p>
          </li>
          <li>
            <p>
              4.5.Mazkur shartnoma va uning ajralmas qismi hisoblangan
              dalolatnomalar elektron tarzda tuziladi hamda ikki tomonning
              “ZeroX” dasturidagi shaxsiy kabinetida saqlanadi.
            </p>
          </li>
          <li>
            <p>
              4.6.Qarz oluvchi va Qarz beruvchi tomonidan Imzo bilan
              tasdiqlangan mazkur shartnomani va uning ajralmas qismi
              hisoblangan dalolatnomalarni “ZeroX” dasturidagi shaxsiy
              kabinetidan istalgan vaqtda koʼchirib olishi hamda chop etishi
              mumkin.
            </p>
          </li>
          <li>
            <p>
              4.7.Imzo bilan tasdiqlangan mazkur shartnoma va uning ajralmas
              qismi hisoblangan dalolatnomalarning saqlanishini Jamiyat oʼz
              zimmasiga oladi.
            </p>
          </li>
          <li>
            <p>
              4.8.Mazkur shartnomaga kiritiladigan har qanday oʼzgartirishlar
              tomonlarning roziligi asosida qoʼshimcha shartnoma tuzish yoʼli
              bilan amalga oshiriladi
            </p>
          </li>
          <li>
            <p>
              4.9.Shartnoma yuzasidan kelib chiqadigan nizolar tomonlarning
              oʼzaro kelishuvi bilan hal etiladi. Jamiyat shartnoma shartlari
              bajarilishini oʼz zimmasiga olmaydi. Tomonlar oʼzaro kelishuvga
              erishmagan taqdirda nizo tegishli tartibda sud orqali hal etiladi.
            </p>
          </li>
        </ul>
      </div>
    </div>
    <div class="box qarz pagebreak">
      <div class="content-title">
        <h2 class="">5.Tomonlarning rekvizitlari</h2>
      </div>
      <div class="content-body">
        <div class="flex">
          <div class="rekvizit">
            ...
            <div class="rek-body">
              ...
              <h2 class="mt-4" v-if="contract.status != 0">
                <Vqr
