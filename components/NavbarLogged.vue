  ...
  >
    ...
    <div class="sidebar-content">
      ...
      <nav class="sidebar-nav">
        ...
        <!-- Qarzdorlar (Start/Premium) -->
        <nuxt-link
          :to="localePath({ name: 'finance-debtors' })"
          class="nav-item"
          @click.native="closeSidebar"
        >
          ...
          <span class="nav-text">{{ $t("menu.debtors") || "Qarzdorlar" }}</span>
        </nuxt-link>

        <!-- SMS boshqaruvi (Start/Premium) -->
        <nuxt-link
          :to="localePath({ name: 'finance-sms' })"
          class="nav-item"
          @click.native="closeSidebar"
        >
          ...
          <span class="nav-text">{{ $t("menu.sms") || "SMS boshqaruvi" }}</span>
        </nuxt-link>
